...
export type LearningMode = "learn" | "fill" | "mc" | "match" | "dictation" | "listen" | "pronunciation" | "sentence" | "timed" | "tone" | "cloze" | "collocation" | "pattern";
...
export const LANGUAGE_REGISTRY: Record<SupportedLanguageCode, LanguageConfig> = {
  en: { code:"en", label:"Tiếng Anh", nativeLabel:"English", badge:"EN", termLabel:"Từ / cụm từ tiếng Anh", pronunciationLabel:"IPA", meaningLabel:"Nghĩa tiếng Việt", ttsLanguage:"en-US", recognitionLanguage:"en-US", fillTermLabel:"Điền từ tiếng Anh", fillUnknownLabel:"Điền từ chưa nhớ", supportedModes:[...COMMON,"sentence","collocation","pattern"] },
  "zh-CN": { code:"zh-CN", label:"Tiếng Trung", nativeLabel:"中文", badge:"中文", termLabel:"Chữ Hán", pronunciationLabel:"Pinyin", meaningLabel:"Nghĩa tiếng Việt", ttsLanguage:"zh-CN", recognitionLanguage:"zh-CN", fillTermLabel:"Điền chữ Hán", fillUnknownLabel:"Điền chữ Hán chưa nhớ", supportedModes:[...COMMON,"tone","cloze","collocation","pattern"] },
};

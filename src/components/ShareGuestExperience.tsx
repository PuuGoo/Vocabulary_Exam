...
type Word = { id: number; meaning: string; term: string | null; example: string | null; wtype: string | null; ipa: string | null; v1: string | null; v2: string | null; v3: string | null; collocations?: Array<{ phrase: string; meaning: string | null; example: string | null; register: string | null }>; patterns?: Array<{ pattern: string; meaning: string | null; example: string | null }>; topics?: string[] };

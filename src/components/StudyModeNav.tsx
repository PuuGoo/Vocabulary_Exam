...
export default function StudyModeNav({ setId, active, isVerb = false, languageCode = "en", availableModes, onSelectMode }: { setId: number; active: StudyMode; isVerb?: boolean; languageCode?: string; availableModes?: readonly string[]; onSelectMode?: (mode: string) => void }) {
